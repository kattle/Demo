...
typedef enum{
    Type_Heartbeat = 0x10,
    Type_Heartbeat_4G = 0x40,
    Type_SetCmd = 0x04,
    Type_FileTrans = 0x05,
    Type_RegCmd = 0x08,
    Type_Elevator_2G = 0x00,
    Type_Elevator_3G = 0x01,
    Type_Elevator_4G = 0x41,
    Type_Buttons = 0x02,
    Type_Buttons_Disable = 0x03,
    Type_RapidPara = 0x0c,
    Type_NONE = 0xff
} FRAME_TYPE;

#define D_ELONGATE_LEN      0xFF  //变长

//以下均指去除头尾两字节的帧长度
#define D_FRAME_HB_LEN              D_ELONGATE_LEN
#define D_FRAME_HB4_LEN             12
#define D_FRAME_CONF_LEN            D_ELONGATE_LEN
#define D_FRAME_FILE_LEN            D_ELONGATE_LEN
#define D_FRAME_REG_LEN             D_ELONGATE_LEN
#define D_FRAME_ELE2_LEN            7
#define D_FRAME_ELE3_LEN            7
#define D_FRAME_ELE4_LEN            20
#define D_FRAME_BTN_LEN             7
#define D_FRAME_BTND_LEN            7
#define D_FRAME_RAPIDPARA_LEN       8
